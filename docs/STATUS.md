...
- Human-only pending evidence: authorize the immutable 0.1.1 tag/publication, observe post-merge release/tag/publish/provenance/published-package checks, create the GitHub release, and submit/inspect the exact Creator Portal version. n8n verification and complete live coverage are not claimed.
