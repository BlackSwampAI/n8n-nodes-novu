...
- Status: implemented locally on `fix/v0.1.2-oidc-recovery`; review and separate release authorization pending
...
- Evidence pending: 0.1.2 PR/default-branch/tag CI, publication, provenance, published scanner/install, GitHub release, and Creator Portal checks have not occurred. No new live API/editor/self-hosted/delivery claim is made.
